    ...
    return(
        <Row > 
            <Col className="col-md-2" >
                ...
                <h3 style={{color:"#283fb1",fontSize:'20px'}}><b>{props.info.length}</b></h3>
            </Col>
            <Col className="col-md-2">
                <h5 style={h5}>Claims to  be  Processed</h5>
                <h3 style={{color:"#283fb1",fontSize:'20px'}}><b>120</b></h3>
            </Col>
            <Col className="col-md-2">
                <h5 style={h5}>Estimated Cost</h5>
                <h3 style={{color:"#283fb1",fontSize:'20px'}}><b>$75,000</b></h3>
            </Col>
            <Col className="col-md-2">
            ...
            <Col className="col-md-2">
                ...
                <h3 style={{color:"#283fb1",fontSize:'20px'}}><b>150</b></h3>
            </Col>
            <Col className="col-md-2">
